...
as
(
select  top 50 execution_count,query_text, TotalLogicalRead,total_logical_writes,([Total Logical Reads (MB)]*100)/(SELECT sum([Total Logical Reads (MB)]) from Read_WriteIO  ) as overallreadweight 
