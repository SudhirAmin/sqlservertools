...
            set @CollectionTime=2 -- in minutes 
...
,@Memrecomm as Memecomm,@memutilization as Memutilization,isnull(@Throughput,0) as throughput,isnull(@totaliops,0) as Totaliops,@edition as edition,
